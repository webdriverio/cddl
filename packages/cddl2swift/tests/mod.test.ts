...
vi.mock('../src/constants', async (importOriginal) => {
    ...
    return {
        ...
        pkg: {
            ...
            version: '0.1.0',
            author: 'Test Author',
            description: 'Generate Swift types from CDDL'
        }
    }
})

describe('cddl2swift CLI', () => {
    ...
    it('should print help if no args were provided', async () => {
        ...
        expect(console.error).toHaveBeenCalledWith(expect.stringMatching(/cddl2swift/))
    ...
    it('should print help when --help is set', async () => {
        ...
        expect(console.log).toHaveBeenCalledWith(expect.stringMatching(/cddl2swift/))
        expect(process.exit).toHaveBeenCalledWith(0)
    })
