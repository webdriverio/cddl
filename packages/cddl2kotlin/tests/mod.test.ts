...
vi.mock('../src/constants', async (importOriginal) => {
    ...
    return {
        ...
        pkg: {
            ...
            version: '0.1.0',
            author: 'Test Author',
            description: 'Generate Kotlin types from CDDL'
        }
    }
})

describe('cddl2kotlin CLI', () => {
    ...
    it('should print help if no args were provided', async () => {
        ...
        expect(console.error).toHaveBeenCalledWith(expect.stringMatching(/cddl2kotlin/))
    ...
    it('should print help when --help is set', async () => {
        ...
        expect(console.log).toHaveBeenCalledWith(expect.stringMatching(/cddl2kotlin/))
        expect(process.exit).toHaveBeenCalledWith(0)
    })
