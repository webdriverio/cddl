...
describe('group choice conversion', () => {
    ...
    it('should generate a union type for group choices (TypedDict)', async () => {
    ...
    it('should generate a union type for group choices (Pydantic)', async () => {
        ...
        expect(output).toContain('class AutodetectProxyConfiguration(')
        expect(output).toMatchSnapshot()
    })
})
